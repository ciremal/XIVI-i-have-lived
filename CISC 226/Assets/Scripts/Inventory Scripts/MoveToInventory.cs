...
public class MoveToInventory : MonoBehaviour
{
  public Vector2[] inventorySlot;
  public GameObject[] itemNumber;
  public IsInInventory other;
  ...
  void Update()
  {
    ...
    if (Input.GetMouseButtonDown(0))
    {
      ...
      if (hit.collider != null)
      {
        ...
        inventorySlot[5] = new Vector2(9f, -3f);

        // Array of "inventory" items (MUST have collider component)
        itemNumber = new GameObject[6];
  ...
  public IEnumerator CallIsInventory(GameObject item){
    ...
    other = gameObject.GetComponent<IsInInventory>();
