...
public class LibraryInventory : MonoBehaviour
{
    public Vector2[] inventorySlot;
    public GameObject[] itemNumber;
    public LibraryIsInInventory other;
    ...
    public LibraryMiniGameManager minigame;
        ...
        if (Input.GetMouseButtonDown(0))
        {
            ...
            if (hit.collider != null)
            {
                ...
                */
                ...
                itemNumber = new GameObject[5];
                itemNumber[0] = GameObject.Find("Cup Of Water");
                itemNumber[1] = GameObject.Find("Lighter");
                itemNumber[2] = GameObject.Find("Locked Book Key");
                itemNumber[3] = GameObject.Find("Special Book");
                itemNumber[4] = GameObject.Find("Kazoo Book Key");
    ...
    public IEnumerator CallIsInventory(GameObject item)
    {
        ...
        other = gameObject.GetComponent<LibraryIsInInventory>();
